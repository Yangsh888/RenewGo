...
class Plugin implements PluginInterface
{
    ...
    public static function apiUrl(string $do): string
    {
        ...
        return \Widget\Security::alloc()->getTokenUrl($path, 'renew-go-admin');
    }
    ...
    private static function buildClientScriptTag(array $settings): string
    {
        ...
        $payload = [
            ...
            'exactUrl' => self::sanitizeUrlArray(array_keys((array) ($rules['exactUrl'] ?? []))),
    ...
    private static function sanitizeUrlArray(array $urls): array
    {
        $result = [];
        foreach ($urls as $url) {
